...
#define SPI2_V_CS_LOW()       GPIO_ResetBits(GPIOB, GPIO_Pin_12)
#define SPI2_V_CS_HIGH()      GPIO_SetBits(GPIOB, GPIO_Pin_12)

#define SPI2_H_CS_LOW()       GPIO_ResetBits(GPIOB, GPIO_Pin_1)
#define SPI2_H_CS_HIGH()      GPIO_SetBits(GPIOB, GPIO_Pin_1)
